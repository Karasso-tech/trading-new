...
- `/filled TICKER` — tell it you bought
...
1,234 tests, all passing. Almost every rule in `CONSISTENCY_RULES.md` has a
test named after the mistake that produced it.

## What is in here

```
bot/          the bot, the rules engine, and the tests (40 test files)
