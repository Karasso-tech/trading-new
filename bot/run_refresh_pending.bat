@echo off
REM Nightly rebuild of stale waiting theses. Each rebuild is a full ~25min screener run, sequential; stops starting new ones two hours before the opening bell.
REM
...
cd /d "%~dp0.."
python "%~dp0run_task.py" refresh_pending
